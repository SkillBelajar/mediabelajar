 ...
 * Page class
 */
class ArtikelMateriDelete extends ArtikelMateri
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "ArtikelMateriDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArtikelMateriList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArtikelMateriList"); // Return to list
                return;
            }
        }
