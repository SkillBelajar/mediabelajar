 ...
 * Page class
 */
class EvaluasiAdd extends Evaluasi
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "EvaluasiAdd";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("id_evaluasi") ?? Route("id_evaluasi")) !== null) {
                ...
                $this->setKey("id_evaluasi", $this->id_evaluasi->CurrentValue); // Set up key
            } else {
                $this->setKey("id_evaluasi", ""); // Clear key
