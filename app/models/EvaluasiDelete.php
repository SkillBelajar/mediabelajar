 ...
 * Page class
 */
class EvaluasiDelete extends Evaluasi
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "EvaluasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EvaluasiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EvaluasiList"); // Return to list
                return;
            }
        }
