 ...
 * Page class
 */
class GeneratorRencanaEdit extends GeneratorRencana
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "GeneratorRencanaEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_generator_rencana") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_generator_rencana->setQueryStringValue($keyValue);
                $this->id_generator_rencana->setOldValue($this->id_generator_rencana->QueryStringValue);
            } elseif (Post("id_generator_rencana") !== null) {
                $this->id_generator_rencana->setFormValue(Post("id_generator_rencana"));
                $this->id_generator_rencana->setOldValue($this->id_generator_rencana->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                // Load key from Form
                if ($CurrentForm->hasValue("x_id_generator_rencana")) {
                    $this->id_generator_rencana->setFormValue($CurrentForm->getValue("x_id_generator_rencana"));
                }
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_generator_rencana->IsDetailKey) {
