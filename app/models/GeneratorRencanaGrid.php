 ...
 * Page class
 */
class GeneratorRencanaGrid extends GeneratorRencana
{
    // Page ID
    public $PageID = "grid";
    ...
    // Page object name
    public $PageObjName = "GeneratorRencanaGrid";
    ...
    public $FormName = "fgenerator_rencanagrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_generator_rencana->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_id_indikator_rencana") && $CurrentForm->hasValue("o_id_indikator_rencana") && $this->id_indikator_rencana->CurrentValue != $this->id_indikator_rencana->OldValue) {
            return false;
        }
    ...
    {
        $this->id_generator_rencana->clearErrorMessage();
        $this->id_indikator_rencana->clearErrorMessage();
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "edit" && is_numeric($this->RowIndex) && $this->RowAction != "delete") {
            $this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $keyName . "\" id=\"" . $keyName . "\" value=\"" . $this->id_generator_rencana->CurrentValue . "\">";
        }
    ...
    public function setRecordKey(&$key, $rs)
    {
        ...
        $key .= $rs->fields['id_generator_rencana'];
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_generator_rencana->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->id_generator_rencana->setFormValue($val);
        }
        ...
        if ($CurrentForm->hasValue("o_id_indikator_rencana")) {
            $this->id_indikator_rencana->setOldValue($CurrentForm->getValue("o_id_indikator_rencana"));
        }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->id_generator_rencana->CurrentValue = $this->id_generator_rencana->FormValue;
        }
    ...
    protected function loadOldRecord()
    {
        ...
        if ($cnt >= 1) {
            if (strval($keys[0]) != "") {
                $this->id_generator_rencana->OldValue = strval($keys[0]); // id_generator_rencana
            } else {
                $validKey = false;
            }
        } else {
    ...
    protected function validateForm()
    {
        ...
        if ($this->id_generator_rencana->Required) {
            if (!$this->id_generator_rencana->IsDetailKey && EmptyValue($this->id_generator_rencana->FormValue)) {
                $this->id_generator_rencana->addErrorMessage(str_replace("%s", $this->id_generator_rencana->caption(), $this->id_generator_rencana->RequiredErrorMessage));
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['id_generator_rencana'];
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // id_indikator_rencana
            $this->id_indikator_rencana->setDbValueDef($rsnew, $this->id_indikator_rencana->CurrentValue, 0, $this->id_indikator_rencana->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "indikator_rencana_belajar") {
            $this->id_indikator_rencana->CurrentValue = $this->id_indikator_rencana->getSessionValue();
        }
        $conn = $this->getConnection();
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "indikator_rencana_belajar") {
            $masterTbl = Container("indikator_rencana_belajar");
            $this->id_indikator_rencana->Visible = false;
