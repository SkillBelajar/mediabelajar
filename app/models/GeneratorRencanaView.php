 ...
 * Page class
 */
class GeneratorRencanaView extends GeneratorRencana
{
    // Page ID
    public $PageID = "view";
    ...
    // Page object name
    public $PageObjName = "GeneratorRencanaView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_generator_rencana") ?? Route("id_generator_rencana")) !== null) {
            $this->RecKey["id_generator_rencana"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_generator_rencana") ?? Route("id_generator_rencana")) !== null) {
                ...
                $this->RecKey["id_generator_rencana"] = $this->id_generator_rencana->QueryStringValue;
            } elseif (Post("id_generator_rencana") !== null) {
                $this->id_generator_rencana->setFormValue(Post("id_generator_rencana"));
                $this->RecKey["id_generator_rencana"] = $this->id_generator_rencana->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_generator_rencana->setQueryStringValue($keyValue);
                $this->RecKey["id_generator_rencana"] = $this->id_generator_rencana->QueryStringValue;
            } else {
                $returnUrl = "GeneratorRencanaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "GeneratorRencanaList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "GeneratorRencanaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
