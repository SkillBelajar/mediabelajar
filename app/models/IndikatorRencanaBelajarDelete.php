 ...
 * Page class
 */
class IndikatorRencanaBelajarDelete extends IndikatorRencanaBelajar
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "IndikatorRencanaBelajarDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IndikatorRencanaBelajarList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IndikatorRencanaBelajarList"); // Return to list
                return;
            }
        }
