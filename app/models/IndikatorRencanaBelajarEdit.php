 ...
 * Page class
 */
class IndikatorRencanaBelajarEdit extends IndikatorRencanaBelajar
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "IndikatorRencanaBelajarEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_indikator") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_indikator->setQueryStringValue($keyValue);
                $this->id_indikator->setOldValue($this->id_indikator->QueryStringValue);
            } elseif (Post("id_indikator") !== null) {
                $this->id_indikator->setFormValue(Post("id_indikator"));
                $this->id_indikator->setOldValue($this->id_indikator->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                // Load key from Form
                if ($CurrentForm->hasValue("x_id_indikator")) {
                    $this->id_indikator->setFormValue($CurrentForm->getValue("x_id_indikator"));
                }
            } else {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // indikator
            $this->indikator->setDbValueDef($rsnew, $this->indikator->CurrentValue, "", $this->indikator->ReadOnly);
