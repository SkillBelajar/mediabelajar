 ...
 * Page class
 */
class IndikatorRencanaBelajarView extends IndikatorRencanaBelajar
{
    // Page ID
    public $PageID = "view";
    ...
    // Page object name
    public $PageObjName = "IndikatorRencanaBelajarView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_indikator") ?? Route("id_indikator")) !== null) {
            $this->RecKey["id_indikator"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_indikator") ?? Route("id_indikator")) !== null) {
                ...
                $this->RecKey["id_indikator"] = $this->id_indikator->QueryStringValue;
            } elseif (Post("id_indikator") !== null) {
                $this->id_indikator->setFormValue(Post("id_indikator"));
                $this->RecKey["id_indikator"] = $this->id_indikator->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_indikator->setQueryStringValue($keyValue);
                $this->RecKey["id_indikator"] = $this->id_indikator->QueryStringValue;
            } else {
                $returnUrl = "IndikatorRencanaBelajarList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "IndikatorRencanaBelajarList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "IndikatorRencanaBelajarList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("RencanaPembelajaranList?" . Config("TABLE_SHOW_MASTER") . "=indikator_rencana_belajar&" . GetForeignKeyUrl("fk_id_indikator", $this->id_indikator->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
