...
class LiveDelete extends Live
{
    ...
    public function run()
    {
        ...
        $this->live_catatan->Visible = false;
        ...
        if ($filter == "") {
            $this->terminate("LiveList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LiveList"); // Return to list
                return;
            }
        }
