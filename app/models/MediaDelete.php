 ...
 * Page class
 */
class MediaDelete extends Media
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "MediaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MediaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MediaList"); // Return to list
                return;
            }
        }
