 ...
 * Page class
 */
class PdfMateriList extends PdfMateri
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "PdfMateriList";
    ...
    public $FormName = "fpdf_materilist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "PdfMateriDelete";
        $this->MultiUpdateUrl = "PdfMateriUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpdf_materilistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->id_pdf_materi->AdvancedSearch->toJson(), ","); // Field id_pdf_materi
        ...
        $filterList = Concat($filterList, $this->file_pdf->AdvancedSearch->toJson(), ","); // Field file_pdf
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpdf_materilistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field id_pdf_materi
        $this->id_pdf_materi->AdvancedSearch->SearchValue = @$filter["x_id_pdf_materi"];
        $this->id_pdf_materi->AdvancedSearch->SearchOperator = @$filter["z_id_pdf_materi"];
        $this->id_pdf_materi->AdvancedSearch->SearchCondition = @$filter["v_id_pdf_materi"];
        $this->id_pdf_materi->AdvancedSearch->SearchValue2 = @$filter["y_id_pdf_materi"];
        $this->id_pdf_materi->AdvancedSearch->SearchOperator2 = @$filter["w_id_pdf_materi"];
        $this->id_pdf_materi->AdvancedSearch->save();
        ...
        // Field file_pdf
        $this->file_pdf->AdvancedSearch->SearchValue = @$filter["x_file_pdf"];
        $this->file_pdf->AdvancedSearch->SearchOperator = @$filter["z_file_pdf"];
        $this->file_pdf->AdvancedSearch->SearchCondition = @$filter["v_file_pdf"];
        $this->file_pdf->AdvancedSearch->SearchValue2 = @$filter["y_file_pdf"];
        $this->file_pdf->AdvancedSearch->SearchOperator2 = @$filter["w_file_pdf"];
        $this->file_pdf->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->file_pdf, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->id_pdf_materi); // id_pdf_materi
            $this->updateSort($this->id_materi); // id_materi
            $this->updateSort($this->file_pdf); // file_pdf
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->id_pdf_materi->setSort("");
                $this->id_materi->setSort("");
                $this->judul->setSort("");
                $this->file_pdf->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_pdf_materi->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpdf_materilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpdf_materilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpdf_materilist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadOldRecord()
    {
        ...
        $validKey = true;
        if (strval($this->getKey("id_pdf_materi")) != "") {
            $this->id_pdf_materi->OldValue = $this->getKey("id_pdf_materi"); // id_pdf_materi
        } else {
            $validKey = false;
        }
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpdf_materilistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
