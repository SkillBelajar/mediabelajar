 ...
 * Page class
 */
class PdfMateriView extends PdfMateri
{
    // Page ID
    public $PageID = "view";
    ...
    // Page object name
    public $PageObjName = "PdfMateriView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_pdf_materi") ?? Route("id_pdf_materi")) !== null) {
            $this->RecKey["id_pdf_materi"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_pdf_materi") ?? Route("id_pdf_materi")) !== null) {
                ...
                $this->RecKey["id_pdf_materi"] = $this->id_pdf_materi->QueryStringValue;
            } elseif (Post("id_pdf_materi") !== null) {
                $this->id_pdf_materi->setFormValue(Post("id_pdf_materi"));
                $this->RecKey["id_pdf_materi"] = $this->id_pdf_materi->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_pdf_materi->setQueryStringValue($keyValue);
                $this->RecKey["id_pdf_materi"] = $this->id_pdf_materi->QueryStringValue;
            } else {
                $returnUrl = "PdfMateriList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PdfMateriList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PdfMateriList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
