 ...
 * Page class
 */
class PesertaAdd extends Peserta
{
    // Page ID
    public $PageID = "add";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("id_peserta") ?? Route("id_peserta")) !== null) {
                ...
                $this->setKey("id_peserta", $this->id_peserta->CurrentValue); // Set up key
            } else {
                $this->setKey("id_peserta", ""); // Clear key
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PesertaView") {
