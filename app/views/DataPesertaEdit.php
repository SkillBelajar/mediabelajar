...
// Page object
$DataPesertaEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fdata_pesertaedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fdata_pesertaedit = currentForm = new ew.Form("fdata_pesertaedit", "edit");

    // Add fields
    var fields = ew.vars.tables.data_peserta.fields;
    fdata_pesertaedit.addFields([
        ["id_data_peserta", [fields.id_data_peserta.required ? ew.Validators.required(fields.id_data_peserta.caption) : null], fields.id_data_peserta.isInvalid],
    ...
    // Validate form
    fdata_pesertaedit.validate = function () {
    ...
    // Form_CustomValidate
    fdata_pesertaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdata_pesertaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fdata_pesertaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdata_pesertaedit" id="fdata_pesertaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id_data_peserta->Visible) { // id_data_peserta ?>
    <div id="r_id_data_peserta" class="form-group row">
        <label id="elh_data_peserta_id_data_peserta" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_data_peserta->caption() ?><?= $Page->id_data_peserta->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_data_peserta->cellAttributes() ?>>
<span id="el_data_peserta_id_data_peserta">
<span<?= $Page->id_data_peserta->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id_data_peserta->EditValue)) ?>"></span>
</span>
<input type="hidden" data-table="data_peserta" data-field="x_id_data_peserta" name="x_id_data_peserta" id="x_id_data_peserta" value="<?= HtmlEncode($Page->id_data_peserta->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
