...
loadjs.ready("head", function () {
    ...
    fminat_siswaadd = currentForm = new ew.Form("fminat_siswaadd", "add");

    // Add fields
    var fields = ew.vars.tables.minat_siswa.fields;
    fminat_siswaadd.addFields([
    ...
    // Validate form
    fminat_siswaadd.validate = function () {
    ...
    // Form_CustomValidate
    fminat_siswaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fminat_siswaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fminat_siswaadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fminat_siswaadd" id="fminat_siswaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
