...
loadjs.ready("head", function () {
    ...
    fpesertaadd = currentForm = new ew.Form("fpesertaadd", "add");

    // Add fields
    var fields = ew.vars.tables.peserta.fields;
    fpesertaadd.addFields([
    ...
    // Form_CustomValidate
    fpesertaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpesertaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpesertaadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpesertaadd" id="fpesertaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
