...
loadjs.ready("head", function () {
    ...
    fterpilihadd = currentForm = new ew.Form("fterpilihadd", "add");

    // Add fields
    var fields = ew.vars.tables.terpilih.fields;
    fterpilihadd.addFields([
    ...
    // Validate form
    fterpilihadd.validate = function () {
    ...
    // Form_CustomValidate
    fterpilihadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fterpilihadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fterpilihadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fterpilihadd" id="fterpilihadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
